...
-- 	,'1' as type
-- 	,CONVERT(VARCHAR(10), APP1.[newstype]) as newsType
...
-- 	,'2' as type
-- 	,CONVERT(VARCHAR(10), APP.[newstype]) as newsType
-- 	,'SYSTEM' as createUser
-- 	,'SYSTEM' as updateUser
...
-- 	,'3' as type
-- 	,CONVERT(VARCHAR(10), PAPER.[newstype]) as newsType
-- 	,'SYSTEM' as createUser
-- 	,'SYSTEM' as updateUser
